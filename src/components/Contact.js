...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-[var(--primary)] flex items-center justify-center">
      <div className="max-w-5xl w-full mx-auto grid grid-cols-1 items-center lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <a 
                ...
                className="text-gray-300 hover:underline text-sm transition-colors"
              >
        ...
        >
          <h2 className="text-lg font-semibold text-white text-center">Send a Message</h2>
          <div className='w-[80%]'>
            <div className="space-y-6">
              <input
                ...
                className="w-full text-sm mb-3 p-btn text-white border border-[var(--tertiary)] rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all"
                required
              />
              <input
                type="email"
              ...
              <textarea
                ...
                className="w-full text-sm mb-3 p-btn text-white border border-[var(--tertiary)] rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all h-20 resize-none"
                required
              />
              <button
