        ...
        <div className="grid grid-cols-[3fr_2fr] gap-x-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="bg-services h-44 text-center rounded-lg" style={{padding: '20px 10px !important'}}>
                    ...
                    <button className="bg-black hover:bg-[var(--hover)] rounded text-sm" style={{padding: '3px 12px', margin: '25px 5px'}}>View Details</button>
                    <button className="bg-black hover:bg-[var(--hover)] rounded text-sm" style={{padding: '3px 12px', margin: '25px 5px'}}>Get Quote</button>
                </div>
                <div className="bg-services h-44 text-center rounded-lg" style={{padding: '20px 10px !important'}}>
