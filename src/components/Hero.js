...
export default function Hero() {
  return (
    <div className="relative bg-[var(--primary)] h-screen flex items-center justify-center overflow-hidden">
      {/* Gradient Background */}
      ...
      <div className="relative z-10 text-center text-white max-w-4xl space-y-6 px-4">
        ...
        <motion.p
          className="text-lg sm:text-xl text-[var(--tertiary)] pb-3 mb-3"
